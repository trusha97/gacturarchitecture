...
import "./TrustedFeature.css";
import { favgold, ft1, ft2, ft3, ft4, trustedabout1 } from "../../utils/images";

const TrustedFeature = () => {
    useEffect(() => {
        AOS.init({
            duration: 1200, // 👈 slow smooth animation
            once: true, // ek var j animate thase
        });
    }, []);
    ...
    return (
        <div className="trusted-feature-div">
            <div className="trusted-div1">
                ...
                <div className="tuested-div-main-div" >
                    <div className="trusted-inner-div">
                        <div
                            className="inspiration-image-text-div122"
                        ...
                        <div
                            className="trust-feature-div-text"
