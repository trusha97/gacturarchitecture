...
import SinglePostSocial from '../SinglePostCreative/Singlepostsocial';
...
const BlogDetailpage = () => {
  ...
  return (
    <div className='blogmain-divin-detail'>
      <div className='blog-detail-main-div'>
        <div className='blog-detail-div-inner'>
